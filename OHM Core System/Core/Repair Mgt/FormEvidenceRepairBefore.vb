...
Public Class FormEvidenceRepairBefore
    ...
    Private Sub Button_Save_Click(sender As Object, e As EventArgs) Handles Button_Save.Click
        ...
        FormRepairUpdate.Label22.Hide()
    End Sub

    Private Sub FormEvidenceRepair_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        cam.Dispose()
    End Sub

    Private Sub FormEvidenceRepair_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub cam_FrameSaved(capImage As Bitmap, imgPath As String) Handles cam.FrameSaved
        ...
        FormRepairUpdate.PictureBox1.Image = New Bitmap(capImage)
