...
Public Class FormEvidenceRepairAfter
    ...
    Private Sub Button_Save_Click(sender As Object, e As EventArgs) Handles Button_Save.Click
        ...
        FormRepairUpdate.Label23.Hide()
    End Sub

    Private Sub FormEvidenceRepairAfter_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        cam.Dispose()
    End Sub

    Private Sub FormEvidenceRepairAfter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub cam_FrameSaved(capImage As Bitmap, imgPath As String) Handles cam.FrameSaved
        PictureBox1.Image = New Bitmap(capImage)
        FormRepairUpdate.PictureBox2.Image = New Bitmap(capImage)
        Label2.Text = "Saved As - " & IO.Path.GetFileName(imgPath)
        Label3.Text = "Image Size - " & PictureBox1.Image.Size.ToString
    End Sub
