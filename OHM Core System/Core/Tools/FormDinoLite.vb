...
Public Class FormDinoLite
    ...
    Private Sub FormDinoLite_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        cam.Dispose()
    End Sub

    Private Sub FormDinoLite_Load(sender As Object, e As EventArgs) Handles Me.Load
        ComboBox_Devices.Items.AddRange(cam.GetCaptureDevices)
