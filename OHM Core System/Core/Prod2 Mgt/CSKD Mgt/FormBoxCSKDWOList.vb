...
Public Class FormBoxCSKDWOList
    Sub customdgv2()
    ...
    Sub LoadData()
        Try
            str = "SELECT line, org, supply_wo, model, pn, demand_wo, pcb, lot_qty, pst, remark, created FROM prodsys2_prod_plan_tbl WHERE pn LIKE 'EBR%'"
    ...
    Private Sub FormBoxCSKDWOList_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call LoadData()
        Call customdgv2()
    End Sub
            ...
            If Me.TabControl1.SelectedIndex = 0 Then ' SMT PLAN
                ...
                ElseIf ComboBox1.Text = "Partnumber" Then
                    ...
                    Catch ex As Exception
                        ...
                        conn.Close()
                    End Try
                ElseIf ComboBox1.Text = "Demand WO" Then
                    DataGridView1.DataSource = Nothing
                    DataGridView1.Refresh()
                    Try
                        str = "select line, org, supply_wo, model, pn, demand_wo, pcb, lot_qty, pst, remark, created from prodsys2_prod_plan_tbl where pn demand_wo '" & TextBox1.Text & "'"
                        Dim da As New MySqlDataAdapter(str, conn)
                        Dim dt As DataTable = New DataTable
                        da.Fill(dt)
                        DataGridView1.DataSource = dt
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        Try
            FormLabelBoxCSKD.TextBox2.Text = Me.DataGridView1.SelectedCells(2).Value.ToString ' wo supply
            FormLabelBoxCSKD.TextBox3.Text = Me.DataGridView1.SelectedCells(4).Value.ToString ' pn
            Me.Close()
        Catch ex As Exception
            MessageBox.Show("ERROR: " & ex.Message, "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
